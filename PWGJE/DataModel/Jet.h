...
using CandidatesDstarData = o2::soa::Join<HfDstarBases, HfDstarPars, HfDstarParEs, HfDstarSels, HfDstarMls, JDstarIds>;
using CandidatesDstarMCD = o2::soa::Join<HfDstarBases, HfDstarPars, HfDstarParEs, HfDstarSels, HfDstarMls, HfDstarMcs, JDstarIds>;
...
using CollisionsB0 = o2::soa::Join<HfB0CollBases, JB0CollisionIds>;
using CandidatesB0Data = o2::soa::Join<HfB0Bases, HfB0Pars, HfB0ParEs, HfB0ParD0s, HfB0Sels, HfB0Mls, HfB0MlD0s, JB0Ids>;
using CandidatesB0MCD = o2::soa::Join<HfB0Bases, HfB0Pars, HfB0ParEs, HfB0ParD0s, HfB0Sels, HfB0Mls, HfB0MlD0s, HfB0Mcs, JB0Ids>;
using JetTracksSubB0 = JTrackB0Subs;
using JetParticlesSubB0 = JMcParticleB0Subs;
using McCollisionsB0 = o2::soa::Join<HfB0McCollBases, JB0McCollisionIds>;
using CandidatesB0MCP = o2::soa::Join<HfB0PBases, JB0PIds>;
