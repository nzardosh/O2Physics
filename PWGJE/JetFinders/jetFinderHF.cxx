...
registry.add("hCandidatePt", "3-prong candidates;inv. mass (#pi K #pi) (GeV/#it{c}^{2});entries", {HistType::kTH1F, {{100, 0.0, 100.0}}});
...
registry.add("hCandidate4Pt", "3-prong candidates;inv. mass (#pi K #pi) (GeV/#it{c}^{2});entries", {HistType::kTH1F, {{100, 0.0, 100.0}}});
...
void processChargedCandidates(CandidateTableMCP const& candidates)
  {
for (auto candidate : candidates) {
registry.fill(HIST("hCandidatePt"), candidate.pt());
}
  }
...
registry.fill(HIST("hCollision"), 2.5);
                             ...
                             CandidateTableMCP const& candidates)
  {
    ...
    for (typename CandidateTableMCP::iterator const& candidate : candidates) {
      registry.fill(HIST("hCandidate4Pt"), candidate.pt());
