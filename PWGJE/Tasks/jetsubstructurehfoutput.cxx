...
struct JetSubstructureHFOutputTask {
                   ...
                   aod::Tracks const& tracks)
  {
    ...
    if (cand.isSelD0bar() >= selectionFlagD0bar) {
      auto invMassCandBar = invMassD0barToKPi(cand);
    }
...
using JetSubstructureHFOutputMCParticleLevel = JetSubstructureHFOutputTask<aod::JetSubstructureHFOutputMCDet>;
using JetSubstructureHFOutputMCDetectorLevel = JetSubstructureHFOutputTask<aod::JetSubstructureHFOutputMCGen>;
