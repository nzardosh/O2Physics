...
struct JetTriggerQA {
  // Preslice<aod::JetConstituents> perJetTrackConstituents = o2::aod::jetconstituents::jetId;
  // Preslice<aod::JetConstituents> perJetClusterConstituents = o2::aod::jetconstituents::jetId;
  ...
  void check_maxJetPt(T1 jet, T2& vecMaxJet)
  {
