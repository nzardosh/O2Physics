...
struct HFDebugTask {
  ...
  Produces<o2::aod::Hf3PBases> LcBaseTable;
  Produces<o2::aod::Hf3PCollBases> LcCollBaseTable;
  Produces<o2::aod::Hf3PCollIds> LcCollIdTable;
  Produces<o2::aod::Hf3PMcCollBases> LcMcCollBaseTable;
  Produces<o2::aod::Hf3PMcCollIds> LcMcCollIdTable;
  Produces<o2::aod::Hf3PMcRCollIds> LcMcRCollIdTable;
  Produces<o2::aod::Hf3PPBases> LcPBaseTable;
  Produces<o2::aod::Hf3PPIds> LcPIdTable;
  Produces<o2::aod::Hf3PPars> LcParTable;
  Produces<o2::aod::Hf3PParEs> LcParETable;
  Produces<o2::aod::Hf3PSels> LcSelTable;
  Produces<o2::aod::Hf3PMls> LcMlTable;
  Produces<o2::aod::Hf3PIds> LcIdTable;
  Produces<o2::aod::Hf3PMcs> LcMcTable;
  ...
  void clearObjetcs(aod::Collisions const&)
  {
    mcCollisionIdD0 = -1;
    mcCollisionIdLc = -1;
  }
  ...
  void processD0MC(soa::Join<aod::Collisions, aod::EvSels, aod::McCollisionLabels>::iterator const& collision, aod::McCollisions const&, aod::McParticles const& particles, soa::Join<aod::Tracks, aod::McTrackLabels> const& tracks)
  {
    ...
    for (auto const& D0Particle : D0Particles) {
      ...
      D0McCollBaseTable(mcCollision.posX(), mcCollision.posY(), mcCollision.posZ());
      D0McCollIdTable(mcCollision.globalIndex());
      std::vector<int> collIDs = {static_cast<int>(D0CollBaseTable.lastIndex())};
      D0McRCollIdTable(collIDs);
      D0PBaseTable(mcCollision.globalIndex(), D0Particle.pt(), D0Particle.eta(), D0Particle.phi(), D0Particle.y(), 1 << o2::aod::hf_cand_2prong::DecayType::D0ToPiK, 0);
      D0PIdTable(mcCollision.globalIndex(), D0Particle.globalIndex());
      D0McTable(1 << o2::aod::hf_cand_2prong::DecayType::D0ToPiK, 0);
    }
  }
  ...
  void processLcMC(soa::Join<aod::Collisions, aod::EvSels, aod::McCollisionLabels>::iterator const& collision, aod::McCollisions const&, aod::McParticles const& particles, soa::Join<aod::Tracks, aod::McTrackLabels> const& tracks)
  {
    ...
    for (auto const& LcParticle : LcParticles) {
      ...
      LcMcCollBaseTable(mcCollision.posX(), mcCollision.posY(), mcCollision.posZ());
      LcMcCollIdTable(mcCollision.globalIndex());
      std::vector<int> collIDs = {static_cast<int>(LcCollBaseTable.lastIndex())};
      LcMcRCollIdTable(collIDs);
      LcPBaseTable(mcCollision.globalIndex(), LcParticle.pt(), LcParticle.eta(), LcParticle.phi(), LcParticle.y(), 1 << o2::aod::hf_cand_3prong::DecayType::LcToPKPi, 0);
      LcPIdTable(mcCollision.globalIndex(), LcParticle.globalIndex());
      LcMcTable(1 << o2::aod::hf_cand_3prong::DecayType::LcToPKPi, 0, 0);
    }
  }
