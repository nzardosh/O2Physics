...
DECLARE_SOA_TABLE_FULL(Dielectrons, "Dielectrons", "AOD", "RTDIELECTRON", //!
                       ...
                       reducedpair::FilterMap, reducedpair::McDecision, // TODO: this McDecision is what you need for the McMathcing
...
// Dilepton collision information (joined with DileptonsExtra) allowing to connect different tables (cross PWGs) //TODO: Add a track index here and in the table readers and the dqefficinecy
