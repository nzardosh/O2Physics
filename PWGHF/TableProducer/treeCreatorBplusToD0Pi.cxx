...
DECLARE_SOA_TABLE(HfCandBplusFull, "AOD", "HFCANDBPFull", full::CandidateId, full::RSecondaryVertex, full::PtProng0, full::PProng0, full::PtProng1, full::PProng1,
                  // full::CandidateSelFlag,
                  full::M, full::Pt, full::P, full::Ct, full::Eta, full::Phi, full::Y, full::DecayLength, full::DecayLengthXY, full::DecayLengthNormalised, full::DecayLengthXYNormalised, full::CPA, full::CPAXY, full::ImpactParameterProduct, hf_cand::ImpactParameter0, hf_cand::ImpactParameter1, full::ImpactParameterNormalised0, full::ImpactParameterNormalised1, hf_cand::PxProng0, hf_cand::PyProng0, hf_cand::PzProng0, hf_cand::PxProng1, hf_cand::PyProng1, hf_cand::PzProng1, hf_cand::Chi2PCA, full::NSigmaTOFBachPi, full::NSigmaTOFBachKa, full::NSigmaTPCBachPi, full::NSigmaTPCBachKa, full::MCflag, full::D0M, full::D0PtProng0, full::D0PtProng1, full::D0Y, full::D0Eta, full::D0CPA, full::D0CPAXY, full::D0Chi2PCA, full::D0DecayLength, full::D0DecayLengthXY, full::D0DecayLengthNormalised, full::D0DecayLengthXYNormalised, full::D0ImpactParameterProduct, full::D0ImpactParameter0, full::D0ImpactParameter1, full::D0ImpactParameterNormalised0, full::D0ImpactParameterNormalised1, full::NSigmaTOFTrk0Pi, full::NSigmaTOFTrk0Ka, full::NSigmaTPCTrk0Pi, full::NSigmaTPCTrk0Ka, full::NSigmaTOFTrk1Pi, full::NSigmaTOFTrk1Ka, full::NSigmaTPCTrk1Pi, full::NSigmaTPCTrk1Ka);
...
DECLARE_SOA_TABLE(HfCandBplusFullParticles, "AOD", "HFCANDBPFullP", full::HfCandBplusParticleId, collision::BCId, full::Pt, full::Eta, full::Phi, full::Y, full::MCflag);
               ...
               aod::HfCand2Prong const&)
  {
    ...
    for (auto& particle : particles) {
      if (std::abs(particle.flagMcMatchGen()) == 1 << DecayType::BplusToD0Pi) {
        rowCandidateFullParticles(particle.globalIndex(), particle.mcCollision().bcId(), particle.pt(), particle.eta(), particle.phi(), RecoDecay::y(array{particle.px(), particle.py(), particle.pz()}, RecoDecay::getMassPDG(particle.pdgCode())), particle.flagMcMatchGen());
      }
    }
  }
};
